...
export default function LessonCard({ lesson, completed }: Props) {
  return (
    <Link
      ...
      className="flex min-h-16 w-full items-center gap-4 rounded-2xl border-2 border-slate-200 bg-white px-4 py-3 shadow-[0_2px_0_#e2e8f0] transition-colors active:bg-slate-100"
    >
