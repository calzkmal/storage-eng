/**
 * The grammar the app teaches, in one place. Both the grading prompt
 * (lib/ai/prompt.ts) and the exercise generator (lib/ai/generate.ts) quote
 * this, so the model judges and writes against the same syllabus as the
 * lesson files. Update it here when the syllabus changes.
 */
...
/**
 * The irregular verbs allowed in exercises, so generated content cannot drift
 * into rare forms a beginner has not met. base / past / past participle.
 */
